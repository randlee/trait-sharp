...
{
    /// <summary>
    /// A mutable enumerable over two trait span views in lockstep.
    /// Created by <see cref="TraitSpan{TLayout}.Zip{T2}(TraitSpan{T2})"/>.
    /// Uses fused two-pointer walk: single MoveNext advances both pointers by shared stride.
    /// </summary>
    public ref struct TraitZipPairs<T1, T2>
        where T1 : unmanaged
        where T2 : unmanaged
    {
        ...
        /// <summary>
        /// Creates a TraitZipPairs from two base references, a shared stride, and length.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal TraitZipPairs(ref byte ref1, ref byte ref2, int stride, int length)
        {
            _ref1 = ref ref1;
            _ref2 = ref ref2;
            _stride = stride;
        ...
        /// <summary>
        /// Enumerates mutable pairs of trait layout references using fused two-pointer walk.
        ...
        public ref struct Enumerator
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal Enumerator(TraitZipPairs<T1, T2> zip)
            {
            ...
            /// <summary>Gets the current mutable pair of trait layout references.</summary>
            public MutableTraitPair<T1, T2> Current
            {
                [MethodImpl(MethodImplOptions.AggressiveInlining)]

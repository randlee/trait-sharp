...
{
    /// <summary>
    /// A mutable enumerable over three trait span views in lockstep.
    /// Created by <see cref="TraitSpan{TLayout}.Zip{T2, T3}(TraitSpan{T2}, TraitSpan{T3})"/>.
    /// Uses fused three-pointer walk: single MoveNext advances all three pointers by shared stride.
    /// </summary>
    public ref struct TraitZipTriples<T1, T2, T3>
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
    {
        ...
        /// <summary>
        /// Creates a TraitZipTriples from three base references, a shared stride, and length.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal TraitZipTriples(ref byte ref1, ref byte ref2, ref byte ref3, int stride, int length)
        {
            _ref1 = ref ref1;
            _ref2 = ref ref2;
            _ref3 = ref ref3;
        ...
        /// <summary>
        /// Enumerates mutable triples of trait layout references using fused three-pointer walk.
        ...
        public ref struct Enumerator
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal Enumerator(TraitZipTriples<T1, T2, T3> zip)
            {
                _current1 = ref Unsafe.SubtractByteOffset(ref zip._ref1, (nint)zip._stride);
                _current2 = ref Unsafe.SubtractByteOffset(ref zip._ref2, (nint)zip._stride);
                _current3 = ref Unsafe.SubtractByteOffset(ref zip._ref3, (nint)zip._stride);
                _stride = zip._stride;
                _length = zip._length;
                _index = -1;
            }
            ...
            /// <summary>Gets the current mutable triple of trait layout references.</summary>
            public MutableTraitTriple<T1, T2, T3> Current
            {
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
